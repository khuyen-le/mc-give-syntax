...
df.demog <- read.csv("../data_pilot/PROCESSED_DATA/pilot_demog.csv")
df.response <- read.csv("../data_pilot/PROCESSED_DATA/pilot_response.csv")
...
length(unique(df.response$subject)) #132
```

```{r}
write.csv(df.response, "../data_pilot/PROCESSED_DATA/pilot_response_excl.csv")
```
